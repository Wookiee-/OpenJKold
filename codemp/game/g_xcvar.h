...
XCVAR_DEF( g_allowEmotes, 			"0", 			NULL, 				CVAR_ARCHIVE, 									qtrue )
...
//JAPRO ADMIN
XCVAR_DEF( g_councilAdminLevel,			"0",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_instructorAdminLevel,		"0",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_knightAdminLevel,			"0",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_councilAdminPass,			"",				NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_instructorAdminPass,		"",				NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_knightAdminPass,			"",				NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_councilAdminMsg,			"",				NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( g_instructorAdminMsg, 		"", 			NULL, 				CVAR_ARCHIVE, 									qfalse )
XCVAR_DEF( g_knightAdminMsg, 			"", 			NULL, 				CVAR_ARCHIVE, 									qfalse )
